...
class PredictModel:
    ...
    def __init__(
        ...
        pet_percentiles_max: float = 51.211158752441406,
    ):
        ...
        self.pet_percentiles_max = pet_percentiles_max
        # print(self.pet_percentiles_max)

        self.load_model(self.ckpts[0])
    ...
    def load_model(self, model_path: str) -> None:
        ...
        """
        self.net = NNUnet.load_from_checkpoint(model_path, sw_batch_size=self.sw_batch_size)
        self.net.eval()
        self.net.cuda()

    @staticmethod
    def preprocess(input: Dict[str, str], pet_percentiles_max=51.211158752441406) -> torch.Tensor:
        ...
        pet_percentiles = (1.0433332920074463, pet_percentiles_max)
    ...
    def run(
        ...
        data = self.preprocess({"ct": ct_file_path, "pet": pet_file_path}, pet_percentiles_max=self.pet_percentiles_max)
        ...
        if save_path is not None:
            ...
            )(output[0], filename=os.path.join(save_path, subid))
