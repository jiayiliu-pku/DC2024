...
class nnUNetTrainerV2_ResencUNet(nnUNetTrainerV2):
    def initialize_network(self):
        ...
        self.num_classes = self.plans['num_classes'] + 1 # need change according to task
        ...
        self.network = FabiansUNet(self.num_input_channels, self.base_num_features, 
                            blocks_per_stage_encoder[:len(conv_kernel_sizes)], 2,
                            pool_op_kernel_sizes, conv_kernel_sizes, cfg, self.num_classes,
                            blocks_per_stage_decoder[:len(conv_kernel_sizes)-1], True, False, 
